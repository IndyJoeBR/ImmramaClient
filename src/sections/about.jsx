...
class About extends React.Component {
    ...
    render () {
        ...
        return (
            <div className="about">
                <h2> -  Immrama  -</h2>
                <h4 className="subTitle">Share Your Journey</h4>
                ...
                <p>Not a traveller?  Maybe you have another journey you have been on.  Starting a new job.  Loosing weight.  Two weeks in quarantine and what you did to amuse yourself.  Learning to play an instrument.  In a way, those are all a kind of journey.  You can share those stories as well.</p>
