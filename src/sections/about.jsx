    ...
    render () {
        ...
        return (
            <div className="about">
                ...
                <h4 className="aboutHeadlines" >What is the connection between an old Irish tale of adventure and this site?</h4>
                ...
                <p>Not a traveller?  Maybe you have another journey you have been on.  Starting a new job.  Loosing weight.  Two weeks in quarantine and what you did to amuse yourself.  Learning to play an instrument.  Those are all a kind of journey.  You can share those stories as well.</p>
