...
class About extends React.Component {
    ...
    render () {
        ...
        return (
            <div className="about">
                <h1 className="primaryHeadline" > -  Immrama  -</h1>
                <h3 className="aboutSubtitle" >Share Your Journey</h3>
            
                <h2 className="aboutHeadline" >About</h2>
                <h5>What are 'immrama'? (The singular is 'immram'.)</h5>
                ...
                <h5>What is the connection between an old Irish tale of adventure and this site?</h5>
                ...
                <h4 className="closingLine" >What is your immram?</h4>
